 ...
 */
class FSkeletalAnimationRateTrackEditor : public FMovieSceneTrackEditor
{
public:
	/**
	 * Constructor
	 ...
	 */
	FSkeletalAnimationRateTrackEditor(TSharedRef<ISequencer> InSequencer);

	/** Virtual destructor. */
	virtual ~FSkeletalAnimationRateTrackEditor() { }
...
class FSkeletalAnimationRateSection
	...
	, public TSharedFromThis<FSkeletalAnimationRateSection>
{
public:
